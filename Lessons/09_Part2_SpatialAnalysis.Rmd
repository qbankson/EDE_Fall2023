...
huc8_sf <- st_read("/Users/mac/Documents/EDE_Fall2023/Data/Spatial/NCHUC8.shp")
...
huc8_sf_challenge <- st_read("/Users/mac/Documents/EDE_Fall2023/Data/Spatial/NCHUC8.shp") %>%
  filter(SUBBASIN == "Upper Neuse")


#Create a map

mapView(counties_sf, ) + mapView(huc8_sf, zcol = "SUBBASIN")

ggplot() + 
  geom_sf(data = huc8_sf, fill = "orange") +
  geom_sf(data = huc8_sf_challenge, fill = "darkorchid")

mapView(huc8_sf, col.region="orange") + mapView(huc8_sf_challenge, col.region="violet")
