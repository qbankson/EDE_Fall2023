...
NTL.phys.data.Tues.90s <- filter(NTL.phys.data, year4 %in% c(1990, 1991, 1992, 1993, 1994, 1995, 1996, 1997, 1998, 1999) & lakename == "Tuesday Lake") 
...
NTL.phys.data.piped <-
  ...
  filter(year4 %in% c(1990, 1991, 1992, 1993, 1994, 1995, 1996, 1997, 1998, 1999)) %>%
...
NTL.phys.data.s.temp <-
  NTL.phys.data.piped %>%
  drop_na(temperature_C) %>%
  filter(depth == 0.00) %>%
  mutate(surface.temp = mean(temperature_C))
...
pivot_longer(NTL.phys.data, irradianceWater, irradianceDeck, names_to = "Irradiance_Type", values_to = "Irradiance_Value")
