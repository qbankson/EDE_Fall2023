...
GaringerOzone.daily.ts <- ts(GaringerOzone$Daily.Max.8.hour.Ozone.Concentration, start =c(fyear.d, fday.d), frequency = 365)
GaringerOzone.monthly.ts <- ts(GaringerOzone.monthly$mean_concentration, start = c(fyear.m, fmonth.m), frequency = 12)
