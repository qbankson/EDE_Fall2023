...
```{r project.setup, error=FALSE, echo=TRUE, message=FALSE, warning=FALSE}
#Import libraries
...
knitr::kable(summary_Ozone, caption = "Mean Particulates(2.5mm)")
```
...
```{r, echo=F,fig.height=5, fig.width=5, fig.cap="Monthly Ozone"}
...
bplot18 <- ggplot(epa_data_18,
                  aes(x = Month, y = Ozone)) +
  geom_boxplot() +
  labs(x = "Month", y = "µg/m³", title = "Monthly Ozone in 2018")
...
bplot19 <- ggplot(epa_data_19,
                  aes(x = Month, y = Ozone)) +
  geom_boxplot() +
  labs(x = "Month", y = "µg/m³", title = "Monthly Ozone in 2019")
...
https://github.com/qbankson/EDE_Fall2023
